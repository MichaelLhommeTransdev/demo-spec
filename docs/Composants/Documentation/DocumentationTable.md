Un tableau permettant l'affichage et la suppression des documentations. Il doit également supporter la sélection multiple pour permettre d'appliquer les actions **archiver** et **supprimer** en masse.
